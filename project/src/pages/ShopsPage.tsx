...
const TEXT = {
  ar: {
    ...
    pageSubtitle: 'إدارة جميع الفروع والعملاء داخل المنصة والتحكم في صلاحياتهم.',
    shopCount: (n: number) => `${n} فرع`,
    globalStat: 'إحصاء عام',
    totalShops: 'إجمالي الفروع',
    activeShops: 'الفروع النشطة',
    inactiveShops: 'الفروع الموقوفة',
    trialShops: 'الفروع التجريبية',
    tabAll: 'جميع الفروع',
    tabActive: 'نشط',
    tabInactive: 'موقوف',
    tabTrial: 'تجريبي',
    searchPlaceholder: 'البحث باسم الفرع أو المدينة...',
    colShopInfo: 'الفرع والمعلومات',
    colLocation: 'الموقع',
    colOwner: 'المالك',
    ...
    noResults: 'لا توجد فروع مطابقة للبحث',
    ...
    saveSuccess: 'تم تحديث بيانات الفرع بنجاح',
    saveError: 'فشل في حفظ التعديلات',
    logoLabel: 'شعار الفرع',
    uploadLogo: 'رفع شعار',
    ...
    marketplaceAccessHint: 'تحديد ما إذا كان الفرع يستطيع رؤية منتجات السوق العام',
    shopStatus: 'حالة الفرع',
    drawerTitle: 'تفاصيل الفرع',
    ...
    deactivateShop: 'إيقاف الفرع',
    activateShop: 'تفعيل الفرع',
    ...
    confirmDeactivate: (name: string) =>
      `هل تريد فعلاً إيقاف فرع "${name}"؟ سيؤدي ذلك لمنعه من تنفيذ الطلبات.`,
    confirmActivate: (name: string) => `هل تريد تفعيل فرع "${name}"؟`,
    dateLocale: 'ar-SA',
    weekday: 'long' as const,
  },
  en: {
    pageTitle: 'Branch Management',
    pageSubtitle: 'Manage all branches and clients on the platform and control their permissions.',
    shopCount: (n: number) => `${n} branches`,
    globalStat: 'Global Stat',
    totalShops: 'Total Branches',
    activeShops: 'Active Branches',
    inactiveShops: 'Inactive Branches',
    trialShops: 'Trial Branches',
    tabAll: 'All Branches',
    tabActive: 'Active',
    tabInactive: 'Inactive',
    tabTrial: 'Trial',
    searchPlaceholder: 'Search by branch name or city...',
    colShopInfo: 'Branch & Info',
    ...
    shopNamePlaceholder: 'Branch name',
    city: 'City',
    ...
    marketplaceAccessHint: 'Controls whether this branch can view products in the public marketplace',
    shopStatus: 'Branch Status',
    drawerTitle: 'Branch Details',
